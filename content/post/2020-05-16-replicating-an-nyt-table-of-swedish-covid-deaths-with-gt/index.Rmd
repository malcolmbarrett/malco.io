...
I recently read an article in the New York Times about [excess deaths in Sweden during the coronavirus outbreak](). As opposed to many of its neighbors, Sweden did not do a general lockdown; instead, it strove to systematically develop [herd immunity](). However, current data suggest that excess deaths (the number of deaths above the usual number) in Sweden are higher than many of its neighbors that enacted early, stricter lockdowns. It's unclear at this point whether this means the approach taken in Sweden doesn't help prevent COVID-19 deaths, but the data are worth considering either way. In the NYT article, the authors present a table of excess deaths for Sweden and other countries in Europe. I thought this table was remarkably good: it's simple, clear, and beautiful.
